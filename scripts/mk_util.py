...
def test_openmp(cc):
    ...
    # disable test for OpenMP
    # 1. it succeeds with clang-3.6, but cmake recipe for OpenMP fails
    #    creating inconsitency during linking
    # 2. new versions of Z3 replaced OpenMP with C++11 concurrency primitives
    #    This version is only maintined for legacy compatibility reasons
    return False
